                    ...
                    >
                        <div className="aspect-[2/3] relative overflow-hidden bg-gray-900">
                            ...
                            <div className="absolute top-2 right-2 flex flex-col gap-1.5 items-end">
                                ...
                                {seasonBadge && (
                                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold shadow-lg uppercase tracking-wider flex items-center gap-1 border border-white/10 ${seasonBadge === 'Multi (s)' ? 'bg-gradient-to-r from-orange-600 to-red-600 text-white' : 'bg-emerald-600 text-white'}`}>
